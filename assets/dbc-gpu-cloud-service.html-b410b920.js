...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8-lease-a-single-virtual-machine" tabindex="-1"><a class="header-anchor" href="#_8-lease-a-single-virtual-machine" aria-hidden="true">#</a> 8. Lease a single virtual machine</h2><h3 id="update-node-and-web-to-the-latest-version-re-pull-the-latest-code" tabindex="-1"><a class="header-anchor" href="#update-node-and-web-to-the-latest-version-re-pull-the-latest-code" aria-hidden="true">#</a> Update node and web to the latest version (re-pull the latest code)</h3><div class="hint-container warning"><p class="hint-container-title">경고</p><p>The re-pulled files need to be re-executed <code>npm install</code> in the folder</p><p>In the <code>HttpRequest</code> under the node folder, just use forever to start <code>router.js</code>, and all js files under <code>TimedTask</code> must be started</p></div><h3 id="preparation" tabindex="-1"><a class="header-anchor" href="#preparation" aria-hidden="true">#</a> Preparation:</h3>`,12),B={href:"https://deepbrainchain.github.io/DBC-Wiki/onchain-guide/rent-machine.html",target:"_blank",rel:"noopener noreferrer"},T={href:"https://deepbrainchain.github.io/DBC-Wiki/install-update-dbc-node/dbc-client-api/http-request-format.html",target:"_blank",rel:"noopener noreferrer"},H={href:"https://deepbrainchain.github.io/DBC-Wiki/install-update-dbc-node/dbc-client-api/http-api.html#%E8%99%9A%E6%8B%9F%E6%9C%BA%E7%BB%84%E7%BD%91",target:"_blank",rel:"noopener noreferrer"},P=n("li",null,[n("p",null,"View rent_end block height(Note that the comma should be removed when the obtained rent_end is saved: 1021788)")],-1),U=i('<figure><img src="'+k+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="add-the-above-information-to-the-database" tabindex="-1"><a class="header-anchor" href="#add-the-above-information-to-the-database" aria-hidden="true">#</a> Add the above information to the database:</h3><ul><li>Set up a virMachine collection (stores machine information for renting a single GPU)</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// virMachine Collection
