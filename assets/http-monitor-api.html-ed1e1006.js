...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><div class="hint-container warning"><p class="hint-container-title">注意</p><p>&quot;additional&quot;中的&quot;servers&quot;字段是个数组，用户最多可以填写两个服务，格式参考:[&quot;ip:port&quot;,&quot;ip:port&quot;]。</p><p>假如需要清空监控服务，数组为空即可，例如:[]。</p></div>`,8),p=[o];function i(c,l){return s(),a("div",null,p)}const r=n(t,[["render",i],["__file","http-monitor-api.html.vue"]]);export{r as default};
