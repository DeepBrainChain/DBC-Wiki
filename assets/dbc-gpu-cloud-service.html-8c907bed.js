...
const <span class="token function">node</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
  ···
  dbc: <span class="token string">&#39;wss://info1.dbcwallet.io&#39;</span> // Official public chain
  ···
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8-lease-a-single-virtual-machine" tabindex="-1"><a class="header-anchor" href="#_8-lease-a-single-virtual-machine" aria-hidden="true">#</a> 8. Lease a single virtual machine</h2><h3 id="update-node-and-web-to-the-latest-version-re-pull-the-latest-code" tabindex="-1"><a class="header-anchor" href="#update-node-and-web-to-the-latest-version-re-pull-the-latest-code" aria-hidden="true">#</a> Update node and web to the latest version (re-pull the latest code)</h3><div class="hint-container warning"><p class="hint-container-title">Note</p><p>The re-pulled files need to be re-executed <code>npm install</code> in the folder</p><p>In the <code>HttpRequest</code> under the node folder, just use forever to start <code>router.js</code>, and all js files under <code>TimedTask</code> must be started</p></div><h3 id="preparation" tabindex="-1"><a class="header-anchor" href="#preparation" aria-hidden="true">#</a> Preparation:</h3>`,12)),e("ul",null,[e("li",null,[e("p",null,[n[11]||(n[11]=s("Rent a whole machine on the chain (",-1)),e("a",D,[n[10]||(n[10]=s("Reference link",-1)),i(a)]),n[12]||(n[12]=s(")",-1))])]),e("li",null,[e("p",null,[n[14]||(n[14]=s("Query session_id information (",-1)),e("a",S,[n[13]||(n[13]=s("The third type in the reference link",-1)),i(a)]),n[15]||(n[15]=s(")",-1))])]),e("li",null,[e("p",null,[n[17]||(n[17]=s("Create network (",-1)),e("a",q,[n[16]||(n[16]=s("Reference link",-1)),i(a)]),n[18]||(n[18]=s(")",-1))])]),n[19]||(n[19]=e("li",null,[e("p",null,"View rent_end block height(Note that the comma should be removed when the obtained rent_end is saved: 1021788)")],-1))]),n[35]||(n[35]=t('<figure><img src="'+f+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="add-the-above-information-to-the-database" tabindex="-1"><a class="header-anchor" href="#add-the-above-information-to-the-database" aria-hidden="true">#</a> Add the above information to the database:</h3><ul><li>Set up a virMachine collection (stores machine information for renting a single GPU)</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// virMachine Collection
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-summary-of-the-problem" tabindex="-1"><a class="header-anchor" href="#_9-summary-of-the-problem" aria-hidden="true">#</a> 9. Summary of the problem</h2><h3 id="_1-start-log-reports-an-error-map-is-null" tabindex="-1"><a class="header-anchor" href="#_1-start-log-reports-an-error-map-is-null" aria-hidden="true">#</a> 1.start.log reports an error: map is null:</h3>`,6)),e("ul",null,[e("li",null,[n[21]||(n[21]=s("Access address with server：",-1)),e("a",B,[n[20]||(n[20]=s("http://api.map.baidu.com/reverse_geocoding/v3/?ak=jQc7i76SLm2k5j54z5y6ppjWjhb0nlhC&output=json&coordtype=wgs84ll&location=",-1)),i(a)]),n[22]||(n[22]=s(" (location=latitude, longitude)",-1))]),n[23]||(n[23]=e("li",null,"Unable to access address, execute:",-1))]),n[36]||(n[36]=e("div",{class:"language-text line-numbers-mode","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,` echo "nameserver 8.8.4.4" | sudo tee /etc/resolv.conf > /dev/null
`)]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"})])],-1)),e("ul",null,[n[29]||(n[29]=e("li",null,"ping 111.206.208.72",-1)),e("li",null,[n[25]||(n[25]=s("ping ",-1)),e("a",A,[n[24]||(n[24]=s("api.map.baidu.com",-1)),i(a)])]),e("li",null,[n[27]||(n[27]=s("Can ping 111.206.208.72 but can't ping ",-1)),e("a",E,[n[26]||(n[26]=s("api.map.baidu.com",-1)),i(a)]),n[28]||(n[28]=s("，Configure in /etc/hosts：",-1))])]),n[37]||(n[37]=t(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>111.206.208.72  api.map.baidu.com
