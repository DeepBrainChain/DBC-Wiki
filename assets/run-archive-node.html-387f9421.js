import{_ as a,V as e,W as n,$ as s}from"./framework-1d64dffd.js";const i={},d=s(`<h1 id="如何运行同步节点" tabindex="-1"><a class="header-anchor" href="#如何运行同步节点" aria-hidden="true">#</a> 如何运行同步节点？</h1><h2 id="_1-配置环境" tabindex="-1"><a class="header-anchor" href="#_1-配置环境" aria-hidden="true">#</a> 1. 配置环境</h2><h3 id="_1-1-使用预编译版本" tabindex="-1"><a class="header-anchor" href="#_1-1-使用预编译版本" aria-hidden="true">#</a> 1.1 使用预编译版本</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">wget</span> https://github.com/DeepBrainChain/DeepBrainChain-MainChain/releases/download/v2.3/dbc_chain_linux_x64.tar.gz <span class="token parameter variable">-O</span> dbc_chain_linux_x64.tar.gz
