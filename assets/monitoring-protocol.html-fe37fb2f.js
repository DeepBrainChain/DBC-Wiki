...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h2 id="zabbix-server-settings" tabindex="-1"><a class="header-anchor" href="#zabbix-server-settings" aria-hidden="true">#</a> zabbix server settings</h2><p>If the server side wants to receive the data sent by dbc, it needs to do the following settings：</p>`,14)),t("ol",null,[t("li",null,[e[4]||(e[4]=n('Import the dbc item template "',-1)),t("a",v,[e[3]||(e[3]=n("DBC VM Template",-1)),a(i)]),e[5]||(e[5]=n('" in zabbix；',-1))]),e[9]||(e[9]=t("li",null,"Create a virtual machine；",-1)),t("li",null,[e[7]||(e[7]=n('Use the template "',-1)),t("a",m,[e[6]||(e[6]=n("DBC VM Template",-1)),a(i)]),e[8]||(e[8]=n('" to add a host in zabbix, fill in the id of the virtual machine for the host name；',-1))]),e[10]||(e[10]=t("li",null,"After the virtual machine is created, the monitoring data can be sent.",-1))])])}const g=s(u,[["render",b],["__file","monitoring-protocol.html.vue"]]);export{g as default};
