import{_ as n,V as s,W as a,$ as t}from"./framework-1d64dffd.js";const e="/DBC-Wiki/assets/wallet_sign-8ad9bef3.png",p="/DBC-Wiki/assets/session_id_sign-1a41ce4c.png",o={},i=t(`<h1 id="http요청-형식-설명" tabindex="-1"><a class="header-anchor" href="#http요청-형식-설명" aria-hidden="true">#</a> HTTP요청 형식 설명</h1><p>요청 방식 : POST</p><p>URL형식: http://&lt;dbc_client_ip&gt;:&lt;dbc_client_port&gt;/api/v1/구체 요청 경로</p><p>body요청:</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
