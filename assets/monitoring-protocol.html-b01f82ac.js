...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h2 id="zabbix-server-设置" tabindex="-1"><a class="header-anchor" href="#zabbix-server-设置" aria-hidden="true">#</a> zabbix server 设置</h2><p>server 端若想接收 dbc 发送的数据，需要做到以下设置：</p>`,14)),n("ol",null,[n("li",null,[e[4]||(e[4]=i('在 zabbix 中导入 dbc 监控项模板"',-1)),n("a",c,[e[3]||(e[3]=i("DBC VM Template",-1)),d(t)]),e[5]||(e[5]=i('"；',-1))]),e[9]||(e[9]=n("li",null,"创建虚拟机；",-1)),n("li",null,[e[7]||(e[7]=i('在 zabbix 中使用模板"',-1)),n("a",b,[e[6]||(e[6]=i("DBC VM Template",-1)),d(t)]),e[8]||(e[8]=i('"添加主机，主机名称填写虚拟机的 task id；',-1))]),e[10]||(e[10]=n("li",null,"等待虚拟机创建完成后即可发送监控数据。",-1))])])}const g=a(u,[["render",m],["__file","monitoring-protocol.html.vue"]]);export{g as default};
