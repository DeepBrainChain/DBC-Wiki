...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8-lease-a-single-virtual-machine" tabindex="-1"><a class="header-anchor" href="#_8-lease-a-single-virtual-machine" aria-hidden="true">#</a> 8. Lease a single virtual machine</h2><h3 id="update-node-and-web-to-the-latest-version-re-pull-the-latest-code" tabindex="-1"><a class="header-anchor" href="#update-node-and-web-to-the-latest-version-re-pull-the-latest-code" aria-hidden="true">#</a> Update node and web to the latest version (re-pull the latest code)</h3><div class="hint-container warning"><p class="hint-container-title">Note</p><p>The re-pulled files need to be re-executed <code>npm install</code> in the folder</p><p>In the <code>HttpRequest</code> under the node folder, just use forever to start <code>router.js</code>, and all js files under <code>TimedTask</code> must be started</p></div><h3 id="preparation" tabindex="-1"><a class="header-anchor" href="#preparation" aria-hidden="true">#</a> Preparation:</h3>`,12),B={href:"https://deepbrainchain.github.io/DBC-Wiki/onchain-guide/rent-machine.html",target:"_blank",rel:"noopener noreferrer"},T={href:"https://deepbrainchain.github.io/DBC-Wiki/install-update-dbc-node/dbc-client-api/http-request-format.html",target:"_blank",rel:"noopener noreferrer"},H={href:"https://deepbrainchain.github.io/DBC-Wiki/install-update-dbc-node/dbc-client-api/http-api.html#%E8%99%9A%E6%8B%9F%E6%9C%BA%E7%BB%84%E7%BD%91",target:"_blank",rel:"noopener noreferrer"},P=n("li",null,[n("p",null,"View rent_end block height(Note that the comma should be removed when the obtained rent_end is saved: 1021788)")],-1),N=i('<figure><img src="'+k+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="add-the-above-information-to-the-database" tabindex="-1"><a class="header-anchor" href="#add-the-above-information-to-the-database" aria-hidden="true">#</a> Add the above information to the database:</h3><ul><li>Set up a virMachine collection (stores machine information for renting a single GPU)</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// virMachine Collection
...
`)]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1),R=n("li",null,"ping 111.206.208.72",-1),M={href:"http://api.map.baidu.com",target:"_blank",rel:"noopener noreferrer"},G={href:"http://api.map.baidu.com",target:"_blank",rel:"noopener noreferrer"},z=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>111.206.208.72  api.map.baidu.com
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_2-the-dbc-client-cannot-connect-to-the-mainnet" tabindex="-1"><a class="header-anchor" href="#_2-the-dbc-client-cannot-connect-to-the-mainnet" aria-hidden="true">#</a> 2.The dbc client cannot connect to the mainnet</h3><ul><li>Add a node to conf/peer.conf in the installation directory: peer=116.169.53.134:5002, restart dbc</li><li>Error in dbc log: check whether the port is open or occupied <img src="`+f+'" alt="" loading="lazy"></li></ul>',3);function $(F,O){const s=c("ExternalLinkIcon");return l(),o("div",null,[x,r(`
...
\`\`\` `),_,n("ul",null,[n("li",null,[e("Register a Paypal account (individual companies are not limited) "),n("a",y,[e("https://www.paypal.com/c2/home"),a(s)])]),n("li",null,[e("Login to paypal developer website "),n("a",w,[e("https://developer.paypal.com/developer/applications/"),a(s)])])]),C,n("ul",null,[n("li",null,[e("Open Alipay Open Platform - Console "),n("a",S,[e("https://open.alipay.com/develop/manage"),a(s)])]),q]),D,n("ul",null,[n("li",null,[e("Obtain the required access data through the official sample document "),n("a",A,[e("https://ideservice.alipay.com/devflow/intelliAssist/page/SC00002446?projectId=670000105#lastFinish"),a(s)]),E])]),j,n("ul",null,[n("li",null,[n("p",null,[e("Rent a whole machine on the chain ("),n("a",B,[e("Reference link"),a(s)]),e(")")])]),n("li",null,[n("p",null,[e("Query session_id information ("),n("a",T,[e("The third type in the reference link"),a(s)]),e(")")])]),n("li",null,[n("p",null,[e("Create network ("),n("a",H,[e("Reference link"),a(s)]),e(")")])]),P]),N,n("ul",null,[n("li",null,[e("Access address with server："),n("a",U,[e("http://api.map.baidu.com/reverse_geocoding/v3/?ak=jQc7i76SLm2k5j54z5y6ppjWjhb0nlhC&output=json&coordtype=wgs84ll&location="),a(s)]),e(" (location=latitude, longitude)")]),I]),L,n("ul",null,[R,n("li",null,[e("ping "),n("a",M,[e("api.map.baidu.com"),a(s)])]),n("li",null,[e("Can ping 111.206.208.72 but can't ping "),n("a",G,[e("api.map.baidu.com"),a(s)]),e("，Configure in /etc/hosts：")])]),z])}const V=t(g,[["render",$],["__file","dbc-gpu-cloud-service.html.vue"]]);export{V as default};
