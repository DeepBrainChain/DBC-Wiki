...
transfer logging = no
strict modes = yes
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p><strong>启动</strong></p><p><code>rsync --daemon</code></p></li><li><p><strong>客户端节点上配置镜像中心地址</strong></p><p><code>image_server=&lt;id&gt;,&lt;ip&gt;,&lt;port&gt;,&lt;modulename&gt;</code></p><p>id: 用户自定义 ID，用于标识改镜像中心</p><p>ip: 镜像中心 ip 地址</p><p>port: 镜像中心服务器上 rsync-server 的监听地址，默认 873，见上述配置文件</p><p>modulename: 镜像中心上配置的模块 ID，默认 images，见上述配置文件</p><p>示例：</p><p><code>image_server=ID_1,127.0.0.1,22,873,images</code></p></li></ul>`,2),l=[r];function o(c,a){return n(),s("div",null,l)}const v=e(d,[["render",o],["__file","deploy_image_server.html.vue"]]);export{v as default};
