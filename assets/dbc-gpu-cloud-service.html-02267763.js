...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_2-the-dbc-client-cannot-connect-to-the-mainnet" tabindex="-1"><a class="header-anchor" href="#_2-the-dbc-client-cannot-connect-to-the-mainnet" aria-hidden="true">#</a> 2.The dbc client cannot connect to the mainnet</h3><ul><li>Add a node to conf/peer.conf in the installation directory: peer=116.169.53.134:5002, restart dbc</li><li>Error in dbc log: check whether the port is open or occupied <img src="`+f+'" alt="" loading="lazy"></li></ul>',3);function z($,F){const s=c("ExternalLinkIcon");return l(),o("div",null,[x,r(`
