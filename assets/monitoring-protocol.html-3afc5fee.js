import{_ as a,V as s,W as o,X as e,Y as t,Z as i,$ as d,F as r}from"./framework-1d64dffd.js";const l={},c=e("h1",{id:"monitoring-protocol",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#monitoring-protocol","aria-hidden":"true"},"#"),t(" monitoring protocol")],-1),u=e("p",null,"Server - dbc data exchange is based on JSON format, Request and response messages must begin with header and data length.",-1),v={href:"https://www.zabbix.com/documentation/5.0/zh/manual/appendix/protocols",target:"_blank",rel:"noopener noreferrer"},m=d(`<h2 id="header-和-data-length" tabindex="-1"><a class="header-anchor" href="#header-和-data-length" aria-hidden="true">#</a> header 和 data length</h2><p>The header is present in response and request messages between Zabbix components. It is required to determine the length of message, if it is compressed or not and the format of message length fields. The header consists of:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;HEADER&gt; - &quot;ZBXD\\x01&quot; (5 bytes)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h2 id="zabbix-server-settings" tabindex="-1"><a class="header-anchor" href="#zabbix-server-settings" aria-hidden="true">#</a> zabbix server settings</h2><p>If the server side wants to receive the data sent by dbc, it needs to do the following settings：</p>`,14),h={href:"https://github.com/DeepBrainChain/DBC-Wiki/blob/main/docs/en/install-and-update-dbc/dbc-monitor/DBC_Host_Templates.xml",target:"_blank",rel:"noopener noreferrer"},b=e("li",null,"Create a virtual machine；",-1),p={href:"https://github.com/DeepBrainChain/DBC-Wiki/blob/main/docs/en/install-and-update-dbc/dbc-monitor/DBC_Host_Templates.xml",target:"_blank",rel:"noopener noreferrer"},g=e("li",null,"After the virtual machine is created, the monitoring data can be sent.",-1);function q(x,f){const n=r("ExternalLinkIcon");return s(),o("div",null,[c,u,e("p",null,[t("This agreement and documentation mainly refer to "),e("a",v,[t("zabbix doc"),i(n)]),t(".")]),m,e("ol",null,[e("li",null,[t('Import the dbc item template "'),e("a",h,[t("DBC VM Template"),i(n)]),t('" in zabbix；')]),b,e("li",null,[t('Use the template "'),e("a",p,[t("DBC VM Template"),i(n)]),t('" to add a host in zabbix, fill in the id of the virtual machine for the host name；')]),g])])}const D=a(l,[["render",q],["__file","monitoring-protocol.html.vue"]]);export{D as default};
