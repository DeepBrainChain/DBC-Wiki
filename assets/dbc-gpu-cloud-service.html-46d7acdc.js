...
const <span class="token function">node</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
    ···
    dbc: <span class="token string">&#39;wss://info1.dbcwallet.io&#39;</span> // 公链正式链
    ···
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="七、支付宝相关文档" tabindex="-1"><a class="header-anchor" href="#七、支付宝相关文档" aria-hidden="true">#</a> 七、支付宝相关文档</h2><h3 id="_1-登录支付宝开发者平台" tabindex="-1"><a class="header-anchor" href="#_1-登录支付宝开发者平台" aria-hidden="true">#</a> 1.登录支付宝开发者平台</h3>`,14)),s("ul",null,[s("li",null,[n[5]||(n[5]=a("打开支付宝开放平台 - 控制台 ",-1)),s("a",C,[n[4]||(n[4]=a("https://open.alipay.com/develop/manage",-1)),i(e)])]),n[6]||(n[6]=s("li",null,[a("选择 网页/移动应用 栏，点击 创建网页/移动应用 按钮，根据提示完成应用创建操作 "),s("img",{src:b,alt:"",loading:"lazy"})],-1))]),n[33]||(n[33]=s("h3",{id:"_2-获取支付所需数据",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#_2-获取支付所需数据","aria-hidden":"true"},"#"),a(" 2.获取支付所需数据")],-1)),s("ul",null,[s("li",null,[n[8]||(n[8]=a("通过官方示例文档，获取所需接入数据 ",-1)),s("a",w,[n[7]||(n[7]=a("https://ideservice.alipay.com/devflow/intelliAssist/page/SC00002446?projectId=670000105#lastFinish",-1)),i(e)]),n[9]||(n[9]=s("img",{src:k,alt:"",loading:"lazy"},null,-1))])]),n[34]||(n[34]=l('<h3 id="_3-检测环境是否准备充分" tabindex="-1"><a class="header-anchor" href="#_3-检测环境是否准备充分" aria-hidden="true">#</a> 3. 检测环境是否准备充分</h3><ul><li>第 2 步创建完成后，通过下图步骤三-账户及应用准备 中可以检测应用是否具有正式使用的能力 <img src="'+h+`" alt="" loading="lazy"></li></ul><h3 id="_4-修改对应配置文件" tabindex="-1"><a class="header-anchor" href="#_4-修改对应配置文件" aria-hidden="true">#</a> 4.修改对应配置文件</h3><ul><li>打开文件夹 src--&gt; locales --&gt; CN.js &amp;&amp; EN.js &amp;&amp; ES.js &amp;&amp; FR.js, 将 showAliPay 字段设置为 0 或 1</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#修改showAliPay
export default {
	···
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="九、问题总结" tabindex="-1"><a class="header-anchor" href="#九、问题总结" aria-hidden="true">#</a> 九、问题总结</h2><h3 id="_1-start-log-报错-map-is-null" tabindex="-1"><a class="header-anchor" href="#_1-start-log-报错-map-is-null" aria-hidden="true">#</a> 1.start.log 报错：map is null</h3>`,6)),s("ul",null,[s("li",null,[n[21]||(n[21]=a("用服务器访问地址：",-1)),s("a",B,[n[20]||(n[20]=a("http://api.map.baidu.com/reverse_geocoding/v3/?ak=jQc7i76SLm2k5j54z5y6ppjWjhb0nlhC&output=json&coordtype=wgs84ll&location=",-1)),i(e)]),n[22]||(n[22]=a(" (location=纬度，经度)",-1))]),n[23]||(n[23]=s("li",null,"无法访问地址，执行：",-1))]),n[36]||(n[36]=s("div",{class:"language-text line-numbers-mode","data-ext":"text"},[s("pre",{class:"language-text"},[s("code",null,` echo "nameserver 8.8.4.4" | sudo tee /etc/resolv.conf > /dev/null
`)]),s("div",{class:"line-numbers","aria-hidden":"true"},[s("div",{class:"line-number"})])],-1)),s("ul",null,[n[29]||(n[29]=s("li",null,"ping 111.206.208.72",-1)),s("li",null,[n[25]||(n[25]=a("ping ",-1)),s("a",j,[n[24]||(n[24]=a("api.map.baidu.com",-1)),i(e)])]),s("li",null,[n[27]||(n[27]=a("可以 ping 111.206.208.72 但无法 ping 通 ",-1)),s("a",E,[n[26]||(n[26]=a("api.map.baidu.com",-1)),i(e)]),n[28]||(n[28]=a(" 时，在/etc/hosts 配置：",-1))])]),n[37]||(n[37]=l(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>111.206.208.72  api.map.baidu.com
