...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="七、支付宝相关文档" tabindex="-1"><a class="header-anchor" href="#七、支付宝相关文档" aria-hidden="true">#</a> 七、支付宝相关文档</h2><h3 id="_1-登录支付宝开发者平台" tabindex="-1"><a class="header-anchor" href="#_1-登录支付宝开发者平台" aria-hidden="true">#</a> 1.登录支付宝开发者平台</h3>`,14),q={href:"https://open.alipay.com/develop/manage",target:"_blank",rel:"noopener noreferrer"},S=n("li",null,[s("选择 网页/移动应用 栏，点击 创建网页/移动应用 按钮，根据提示完成应用创建操作 "),n("img",{src:m,alt:"",loading:"lazy"})],-1),D=n("h3",{id:"_2-获取支付所需数据",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_2-获取支付所需数据","aria-hidden":"true"},"#"),s(" 2.获取支付所需数据")],-1),j={href:"https://ideservice.alipay.com/devflow/intelliAssist/page/SC00002446?projectId=670000105#lastFinish",target:"_blank",rel:"noopener noreferrer"},B=n("img",{src:b,alt:"",loading:"lazy"},null,-1),E=i('<h3 id="_3-检测环境是否准备充分" tabindex="-1"><a class="header-anchor" href="#_3-检测环境是否准备充分" aria-hidden="true">#</a> 3. 检测环境是否准备充分</h3><ul><li>第 2 步创建完成后，通过下图步骤三-账户及应用准备 中可以检测应用是否具有正式使用的能力 <img src="'+k+`" alt="" loading="lazy"></li></ul><h3 id="_4-修改对应配置文件" tabindex="-1"><a class="header-anchor" href="#_4-修改对应配置文件" aria-hidden="true">#</a> 4.修改对应配置文件</h3><ul><li>打开文件夹 src--&gt; locales --&gt; CN.js &amp;&amp; EN.js &amp;&amp; ES.js &amp;&amp; FR.js, 将 showAliPay 字段设置为 0 或 1</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#修改showAliPay
export default {
	···
...
`)]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1),T=n("li",null,"ping 111.206.208.72",-1),$={href:"http://api.map.baidu.com",target:"_blank",rel:"noopener noreferrer"},G={href:"http://api.map.baidu.com",target:"_blank",rel:"noopener noreferrer"},z=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>111.206.208.72  api.map.baidu.com
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_2-dbc-客户端无法连接到主网" tabindex="-1"><a class="header-anchor" href="#_2-dbc-客户端无法连接到主网" aria-hidden="true">#</a> 2.dbc 客户端无法连接到主网</h3><ul><li>在安装目录下 conf/peer.conf 中添加节点：peer=116.169.53.134:5002,重启 dbc</li><li>dbc 日志出现报错：检查端口是否开启或被占用 <img src="`+g+'" alt="" loading="lazy"></li></ul>',3);function W(F,M){const a=r("ExternalLinkIcon");return t(),c("div",null,[_,d(`
...
\`\`\` `),f,n("ul",null,[n("li",null,[s("注册 Paypal 账户(个人公司不限) "),n("a",y,[s("https://www.paypal.com/c2/home"),e(a)])]),n("li",null,[s("登录 paypal 开发者网站 "),n("a",C,[s("https://developer.paypal.com/developer/applications/"),e(a)])])]),w,n("ul",null,[n("li",null,[s("打开支付宝开放平台 - 控制台 "),n("a",q,[s("https://open.alipay.com/develop/manage"),e(a)])]),S]),D,n("ul",null,[n("li",null,[s("通过官方示例文档，获取所需接入数据 "),n("a",j,[s("https://ideservice.alipay.com/devflow/intelliAssist/page/SC00002446?projectId=670000105#lastFinish"),e(a)]),B])]),E,n("ul",null,[n("li",null,[s("在链上租用一台整机（"),n("a",A,[s("参考链接"),e(a)]),s("）")]),n("li",null,[s("查询 session_id 信息（"),n("a",H,[s("参考链接中的第三种类型"),e(a)]),s("）")]),n("li",null,[s("创建网络（"),n("a",P,[s("参考链接"),e(a)]),s("）")]),N]),L,n("ul",null,[n("li",null,[s("用服务器访问地址："),n("a",U,[s("http://api.map.baidu.com/reverse_geocoding/v3/?ak=jQc7i76SLm2k5j54z5y6ppjWjhb0nlhC&output=json&coordtype=wgs84ll&location="),e(a)]),s(" (location=纬度，经度)")]),I]),R,n("ul",null,[T,n("li",null,[s("ping "),n("a",$,[s("api.map.baidu.com"),e(a)])]),n("li",null,[s("可以 ping 111.206.208.72 但无法 ping 通 "),n("a",G,[s("api.map.baidu.com"),e(a)]),s(" 时，在/etc/hosts 配置：")])]),z])}const X=l(x,[["render",W],["__file","dbc-gpu-cloud-service.html.vue"]]);export{X as default};
