...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8-lease-a-single-virtual-machine" tabindex="-1"><a class="header-anchor" href="#_8-lease-a-single-virtual-machine" aria-hidden="true">#</a> 8. Lease a single virtual machine</h2><h3 id="update-node-and-web-to-the-latest-version-re-pull-the-latest-code" tabindex="-1"><a class="header-anchor" href="#update-node-and-web-to-the-latest-version-re-pull-the-latest-code" aria-hidden="true">#</a> Update node and web to the latest version (re-pull the latest code)</h3><div class="custom-container warning"><p class="custom-container-title">\u6CE8\u610F</p><p>The re-pulled files need to be re-executed <code>npm install</code> in the folder</p><p>In the <code>HttpRequest</code> under the node folder, just use forever to start <code>router.js</code>, and all js files under <code>TimedTask</code> must be started</p></div><h3 id="preparation" tabindex="-1"><a class="header-anchor" href="#preparation" aria-hidden="true">#</a> Preparation:</h3>`,12),R=e("Rent a whole machine on the chain ("),U={href:"https://deepbrainchain.github.io/DBC-Wiki/onchain-guide/rent-machine.html",target:"_blank",rel:"noopener noreferrer"},P=e("Reference link"),W=e(")"),M=e("Query session_id information ("),$={href:"https://deepbrainchain.github.io/DBC-Wiki/install-update-dbc-node/dbc-client-api/http-request-format.html",target:"_blank",rel:"noopener noreferrer"},F=e("The third type in the reference link"),G=e(")"),O=e("Create network ("),z={href:"https://deepbrainchain.github.io/DBC-Wiki/install-update-dbc-node/dbc-client-api/http-api.html#%E8%99%9A%E6%8B%9F%E6%9C%BA%E7%BB%84%E7%BD%91",target:"_blank",rel:"noopener noreferrer"},V=e("Reference link"),X=e(")"),K=n("li",null,[n("p",null,"View rent_end block height(Note that the comma should be removed when the obtained rent_end is saved: 1021788)")],-1),Q=i('<p><img src="'+h+`" alt=""></p><h3 id="add-the-above-information-to-the-database" tabindex="-1"><a class="header-anchor" href="#add-the-above-information-to-the-database" aria-hidden="true">#</a> Add the above information to the database:</h3><ul><li>Set up a virMachine collection (stores machine information for renting a single GPU)</li></ul><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>// virMachine Collection
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_2-the-dbc-client-cannot-connect-to-the-mainnet" tabindex="-1"><a class="header-anchor" href="#_2-the-dbc-client-cannot-connect-to-the-mainnet" aria-hidden="true">#</a> 2.The dbc client cannot connect to the mainnet</h3><ul><li>Add a node to conf/peer.conf in the installation directory: peer=116.169.53.134:5002, restart dbc</li><li>Error in dbc log: check whether the port is open or occupied <img src="`+k+'" alt=""></li></ul>',5);function an(tn,ln){const s=l("ExternalLinkIcon");return o(),r("div",null,[g,n("ul",null,[n("li",null,[_,n("a",x,[y,a(s)])]),n("li",null,[w,n("a",C,[q,a(s)])])]),D,n("ul",null,[n("li",null,[S,n("a",A,[E,a(s)])]),B]),j,n("ul",null,[n("li",null,[H,n("a",I,[L,a(s)]),T])]),N,n("ul",null,[n("li",null,[n("p",null,[R,n("a",U,[P,a(s)]),W])]),n("li",null,[n("p",null,[M,n("a",$,[F,a(s)]),G])]),n("li",null,[n("p",null,[O,n("a",z,[V,a(s)]),X])]),K]),Q,n("ul",null,[n("li",null,[J,n("a",Y,[Z,a(s)]),nn]),en]),sn])}var cn=t(f,[["render",an],["__file","dbc-gpu-cloud-service.html.vue"]]);export{cn as default};
