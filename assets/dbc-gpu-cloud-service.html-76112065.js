...
\`\`\` `),f,n("ul",null,[n("li",null,[s("注册 Paypal 账户(个人公司不限) "),n("a",y,[s("https://www.paypal.com/c2/home"),e(a)])]),n("li",null,[s("登录 paypal 开发者网站 "),n("a",C,[s("https://developer.paypal.com/developer/applications/"),e(a)])])]),w,n("ul",null,[n("li",null,[s("打开支付宝开放平台 - 控制台 "),n("a",D,[s("https://open.alipay.com/develop/manage"),e(a)])]),q]),S,n("ul",null,[n("li",null,[s("通过官方示例文档，获取所需接入数据 "),n("a",B,[s("https://ideservice.alipay.com/devflow/intelliAssist/page/SC00002446?projectId=670000105#lastFinish"),e(a)]),j])]),E,n("ul",null,[n("li",null,[s("在链上租用一台整机（"),n("a",H,[s("参考链接"),e(a)]),s("）")]),n("li",null,[s("查询 session_id 信息（"),n("a",A,[s("参考链接中的第三种类型"),e(a)]),s("）")]),n("li",null,[s("创建网络（"),n("a",P,[s("参考链接"),e(a)]),s("）")]),N]),L,n("ul",null,[n("li",null,[s("用服务器访问地址："),n("a",U,[s("http://api.map.baidu.com/reverse_geocoding/v3/?ak=jQc7i76SLm2k5j54z5y6ppjWjhb0nlhC&output=json&coordtype=wgs84ll&location="),e(a)]),s(" (location=纬度，经度)")]),I]),R,n("ul",null,[T,n("li",null,[s("ping "),n("a",W,[s("api.map.baidu.com"),e(a)])]),n("li",null,[s("可以 ping 111.206.208.72 但无法 ping 通 "),n("a",$,[s("api.map.baidu.com"),e(a)]),s(" 时，在/etc/hosts 配置：")])]),G])}const X=l(x,[["render",z],["__file","dbc-gpu-cloud-service.html.vue"]]);export{X as default};
