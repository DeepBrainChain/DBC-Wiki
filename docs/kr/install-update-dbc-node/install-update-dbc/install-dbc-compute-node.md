...
- 주의: DBC유저 설치 전환 필요
  ...
  1.dbc성능 노드 설치 스크립트 다운로드:http://116.169.53.132:9000/dbc/install_update_script/mainnet/install_mining.sh
...
http://116.169.53.132:9000/image 다운로드：ubuntu.qcow2 和 ubuntu-2004.qcow2 이두개의 미러이미지#
...
- 테스트 프로그램 다운로드 주소 :http://116.169.53.132:9000/dbc/package/check_env
