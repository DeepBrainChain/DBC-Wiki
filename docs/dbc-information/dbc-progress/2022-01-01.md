...
4. [https://github.com/DeepBrainChain/substrate-api-sidecar](https://github.com/DeepBrainChain/substrate-api-sidecar)：DBC substrate API接口库

  8次commits提交, 17 个文件被修改, 535 行代码被插入

5. [https://github.com/DeepBrainChain/PolkaWallet_Plugin_DBC](https://github.com/DeepBrainChain/PolkaWallet_Plugin_DBC)：DBC手机钱包
